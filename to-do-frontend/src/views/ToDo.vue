<template>
  ...
  <section class="bg-gray-50 p-3 antialiased dark:bg-gray-900 sm:p-5">
    <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
      <!-- Start coding here -->
      <div
          class="relative overflow-hidden bg- shadow-md dark:bg-gray-800 sm:rounded-lg"
      >
        <nav
...
import DataTable from '../components/ToDo/DataTable.vue'
import BaseModel from '../components/ToDo/BaseModal.vue'
